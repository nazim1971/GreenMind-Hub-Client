      ...
      <div className="space-y-12">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Discover how cities worldwide are implementing innovative
                  waste reduction strategies and how you can bring these ideas
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  ...
                  that won&apos;t break the bank but will reduce your carbon
                  footprint.
                </p>
                <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  Everything you need to know to start composting at home, even
                  in small spaces.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  How to make the switch to bicycle commuting safely and
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  Identify where your home is wasting energy and how to fix it
                  with our DIY audit checklist.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="mt-6 bg-green-50 dark:bg-green-900/30 rounded-lg p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Read the inspiring story of how one ThinkGreenly member mobilized
              their community to dramatically reduce single-use plastics through
              simple, collective actions.
            </p>
            <Link
              href="/blogs/community-plastic-reduction"
