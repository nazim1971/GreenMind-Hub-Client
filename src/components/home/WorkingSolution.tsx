  ...
  return (
    <div className="w-full px-4 sm:px-8 lg:px-16 rounded-2xl py-20 bg-[#F4FAF7] dark:bg-gray-900">
      <section className="text-center mb-20">
        ...
        <p className=" sm:text-xl text-gray-600 dark:text-gray-300 mx-auto max-w-3xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          ...
          <h3 className="sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">Recycling Waste</h3>
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          ...
          <h3 className="text-lg sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">The Eco System</h3>
          <p className="text-gray-600 dark:text-gray-300 text-center">
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          ...
          <h3 className="text-lg sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">Water Refining</h3>
          <p className="text-gray-600 dark:text-gray-300 text-center">
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          ...
          <h3 className="text-lg sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">Wind Energy</h3>
          <p className="text-gray-600 dark:text-gray-300 text-center">
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          ...
          <h3 className="text-lg sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">Dynamic Ecology</h3>
          <p className="text-gray-600 dark:text-gray-300 text-center">
        ...
        <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1">
          <Trees size={80} color="#14B8A6" className="mb-4 mx-auto" />
          <h3 className="text-lg sm:text-2xl font-semibold text-[#14B8A6] mb-3 text-center">Saving Plants</h3>
          <p className="text-gray-600 dark:text-gray-300 text-center">
